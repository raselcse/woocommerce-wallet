...
jQuery(function ($) {
        ...
        do_refund_partial_payment_amount: function () {
            if (window.confirm(woocommerce_admin_meta_boxes.i18n_do_refund)) {
                ...
                var data = {
                    ...
                    wallet_type: $(this).attr('wallet_type')
                };
    ...
    // $('.wc-order-bulk-actions').on('click',function(){
    //     console.log($('.wc-order-bulk-actions .wc-order-totals tr:eq(1)'));
    //     $('div.wc-order-data-row.wc-order-totals-items.wc-order-items-editable tr.cashback-total-row').insertAfter(".wc-order-refund-items.wc-order-data-row-toggle > table > tbody > tr:nth-child(2)");
    //  })
});